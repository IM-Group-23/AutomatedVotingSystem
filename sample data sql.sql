...
insert into contestant values(1,'ab','UNP',1);
insert into contestant values(3,'bc','UNP',1);
insert into contestant values(4,'cd','UNP',1);
insert into contestant values(2,'dss','UPFA',1);
...
insert into election_commissioner values('ele1','asda','sff','sf','adf','af');
